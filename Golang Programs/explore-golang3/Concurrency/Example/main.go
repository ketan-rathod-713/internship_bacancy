...
Isme ek poller he jiska kam he resource se information poll karna
ek he status monitor jo ki monitor karta he new updates from poller and prints status of resources each interval of time
...
func StateMonitor(updateInterval time.Duration) chan<- State {
	...
	// jab updates aate he tab update karo else normal ticker pe print karo
	go func() {
		for {
			select {
			case <-ticker.C:
